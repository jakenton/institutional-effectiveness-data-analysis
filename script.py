# The following code automatically imports the data fields into a pandas DataFrame called 'dataset'.
...
# Visualization (Uses only Matplotlib)
...
# Uses Matplotlib's bar function instead of Seaborn, mapping the demographic group names to the x-axis and the scores to the y-axis
bars = plt.bar(
...
# Setting the Y-axis explicitly from 0 to 100 for accurate representation and spacing.
plt.ylim(0, 100) 
...
# Adjusts layout to prevent clipping
plt.tight_layout()
plt.show()